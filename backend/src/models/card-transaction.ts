...
CardTransactionSchema.index({
  workspaceId: 1,
  userCardId: 1,
  transactionDate: -1,
});
CardTransactionSchema.index({ workspaceId: 1, statementId: 1 });
export const CardTransactionModel = (mongoose.models.CardTransaction ??
  mongoose.model("CardTransaction", CardTransactionSchema)) as mongoose.Model<
