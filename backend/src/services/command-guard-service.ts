...
const validResourceKeys = new Set(["type", "id", "resourceType", "resourceId", "cardId", "statementId", "accountId", "sourceAccountIds", "transactionCount", "beforeBalance", "afterBalance", "reason", "correctionType"]);
