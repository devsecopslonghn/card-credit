...
registerAccountRoutes(app, config.authSecret);
registerFinancialTransactionRoutes(app, config.authSecret);
registerFinancialReportRoutes(app, config.authSecret);
registerFinanceRoutes(app, config.authSecret);
registerRecurringExpenseRoutes(app, config.authSecret);
