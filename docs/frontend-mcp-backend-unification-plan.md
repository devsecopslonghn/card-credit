...
| `GAP-PAY-01/02`, `GAP-STM-01` | `PARTIAL` | Shared payment contract, state machine, preview, CAS, idempotency và command tests | Persistence/reconciliation evidence; reversal policy |
