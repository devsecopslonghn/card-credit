...
| P1 | `GAP-UI-02`, `GAP-UI-03` | **PARTIAL** — Reports đã có canonical date-range filters; Budgets đã có canonical upsert form/client và regression evidence; recurring update/delete/generation và UI acceptance runtime còn thiếu | Hoàn thiện recurring lifecycle/UI acceptance và giữ report/planning regression gate |
