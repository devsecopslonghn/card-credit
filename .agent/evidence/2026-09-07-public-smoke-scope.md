...
- relevant Git diff/commit: pending commit on `master`; changed `frontend/scripts/smoke-test.mjs`, `frontend/tests/smokeBoundary.test.mjs`, `README.md`, and task record.
