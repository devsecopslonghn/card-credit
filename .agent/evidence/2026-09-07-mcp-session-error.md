...
- relevant Git diff/commit: `6ead1c0 fix: return stable MCP session errors`; changed `backend/src/mcp/http.ts`, `backend/tests/mcp-inventory.test.ts`, task record and state.
