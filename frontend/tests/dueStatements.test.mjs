...
test("cards page sends persisted card and statement ids and replaces successful statement state", () => {
  ...
  assert.match(source, /updateStatementPayment\(statement\.userCardId, statement\._id, action, repaymentAccountId \|\| undefined, commandKey, preview\.version \?\? undefined\)/);
